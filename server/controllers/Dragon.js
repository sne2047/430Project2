...
const makeDragon = (req, res) => {
  ...
  if (!req.body.name || !req.body.bodyColor || !req.body.hornType
          || !req.body.hornColor || !req.body.eyeType) {
  ...
  return Account.AccountModel.isPremium(req.session.account.username, (error, isPremium) => {
    if (error) {
